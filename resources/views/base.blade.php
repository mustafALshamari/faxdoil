...
<main class="site-main home-page" role="main">
...
<div class="mainContent-footerBanner">
    <div class="footerBanner_wrapper">
        <div class="footerBanner_content">
            <h4>Pueraria Mirifica And Study Phyto Estrogens</h4>
            <p>Natural Beauty From Natural Ingredients</p>
            <p>Natural Beauty From Natural Ingredients</p>
        ...
        <div class="footerBanner_img">
            <img src="./assets/images/Real-Clearly-White.png" alt="">
        </div>
    </div>
</div>
